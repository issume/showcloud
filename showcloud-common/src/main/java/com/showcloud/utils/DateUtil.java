...
public class DateUtil {
	 ...
	 * @return
	 */
	public static int getDiffMilliseconds(Date one, Date two) {
	...
	public static void main(String[] args) {
		...
		System.out.println(getFistDayOfCurrentYear());
	}
	 ...
	 * @return 新的日期
	 */
	public static Date subtractDays(Date date1, long days) {
		return subtractSeconds(date1, days * ONE_DAY_SECONDS);
	}
	...
	public static Date subtractSeconds(Date date1, long secs) {
		return new Date(date1.getTime() - (secs * 1000));
	}
	...
	public static String getFirstDayOfWeek() {
		...
		return getWebDateString(calendar.getTime());
	}
	 ...
	 * @return
	 */
	public static String getFistDayOfCurrentYear() {
	 ...
	 * @return
	 */
	public static String getMonthFristDay(Date date, int subtract) {
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
		return df.format(getMonthFristDate(date, subtract));
	}
	 ...
	 * @return
	 */
	public static Date getDay (Date date, int substract) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
		calendar.add(Calendar.DAY_OF_MONTH, substract);
	 ...
	 * @return
	 */
	public static String getMonthLastDay(Date date, int substract) {
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd :23:59:59");
		return df.format(getMonthLastDate(date, substract));
	}
	 ...
	 * @return
	 */
	public static Date getMonthLastDate(Date date, int substract) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
	 ...
	 * @return
	 */
	public static Date getMonthFristDate(Date date, int subtract) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
